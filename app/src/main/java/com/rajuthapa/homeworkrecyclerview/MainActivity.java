package com.rajuthapa.homeworkrecyclerview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // add data
        for (int i = 0; i < 20; i++) {
            FoodRecipe foodRecipe = new FoodRecipe(title, briefDescription, ingredients, procedure, R.drawable.ic_baseline_fastfood_24);
